...
- On Android 12+, font modules will crash apps if you hide Magisk from those apps. OverlayFS will keep all font files intact after magisk module files are unmounted for those apps.
